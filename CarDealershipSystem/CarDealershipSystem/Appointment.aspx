<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Appointment.aspx.cs" Inherits="CarDealershipSystem.LoginforBuyer" %>
  ...
  <h3 class="card-header bg-light" style="font-size: x-large" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Please enter buyer credentials</h3>
    <form id="form1" runat="server">   
        ...
        <p style="margin-left: 173px">&nbsp;
            ...
            <asp:TextBox ID="TextBox1" runat="server" Width="250px" OnTextChanged="TextBox1_TextChanged1"></asp:TextBox>
        </p>
        <p style="margin-left: 160px">
            <asp:Label style="font-size: large" ID="Label3" runat="server" Text="Amount" ForeColor="White"></asp:Label>
      ...
      <br />
        ...
        <asp:Button ID="Button1" runat="server" Text="Login" OnClick="Button1_Click" CssClass="btn btn-outline-primary" BorderStyle="Solid" BorderColor="White" ForeColor="White" style="width: 48px" />
        <br />
        <br />
